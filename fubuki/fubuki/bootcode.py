...
assert len(BR_FAT32KOS_0X52) == 430

BR_FAT32ROS_0X52 = bytes([
...
assert len(BR_FAT32ROS_0X52) == 918

BR_FAT32ROS_0X3F0 = bytes([
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x55, 0xaa,
])
assert len(BR_FAT32ROS_0X3F0) == 16

BR_FAT32ROS_0X1C00 = bytes([
...
assert len(BR_FAT32ROS_0X1C00) == 512

BR_FAT16ROS_0X3E = bytes([
...
assert len(BR_FAT16ROS_0X3E) == 450

MBR_REACTOS_0X0 = bytes([
...
assert len(MBR_REACTOS_0X0) == 267

MBR_KOLIBRI_0X0 = bytes([
...
assert len(MBR_KOLIBRI_0X0) == 440
