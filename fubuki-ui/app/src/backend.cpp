...
// (QT_LOGGING_RULES="fubuki.ui.debug=true"), so a run can be watched
// from a terminal without a window.
Q_LOGGING_CATEGORY(lcUsb, "fubuki.ui", QtWarningMsg)

namespace {
constexpr auto DefaultEngine = "/usr/bin/fubuki";
...
QString enginePath()
{
    const QString override = qEnvironmentVariable("FUBUKI_ENGINE");
